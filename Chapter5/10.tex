...
$$
    \begin{cases}
        \Hat I^2 &\to -\hbar \Dta_{\theta, \phi}\\
        \Hat I_z &\to -i \hbar \ud{}{\phi}
    \end{cases}
$$
Уравнение
$$
...
Вспомни свойство оператора спина:
\begingroup
\def \Ssq {\vec {\Hat S}^2}
\def \Sz {\Hat S_z}
$$
...
$$
    \X_{s, m_s = s} = \begin{bmatrix}
                      ...
                      \end{bmatrix}^\top
$$
Такие столбцы называются \emph{спиноры}. Всё пространство натянуто на эти два спинора, поэтому спиновое пространство реализуется как $\mathbb{C}_2$.
...
\begin{eqnarray*}
    ...
    \underbrace{\qs{\Psi_A}{\vec r, m_s}}_{\text{сопряженный спинор}}
    \underbrace{\qtri{m_s}{\Hat\F}{m_s'}}_{\text{matrix $2 \times 2$}}
