...
Надо ввести коммутационные соотношения. Для этой цели мы будем использовать принцип соответствия, и будет строить наше квантово-механическое описание так, чтобы оно примыкало к классическому насколько тесно, настолько это возможно.
$$
