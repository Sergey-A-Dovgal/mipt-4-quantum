...
Постулаты Бора:\\
1) постулат стационарного состояния\\
2) постулат частот
$$
...
Например, монохроматическая волна, распространяющаяся в положительном направлении оси $X$
$$
...
$\vec{v_{\text{гр}}}$ -- скорость центра масс волнового пакета\index{Групповая скорость}\\
$$
...
Макс Борн, 1926г. -- статистическое (вероятностное) значение (интерпретация) волновой функции.\index{Волновая функция! статистическое значение}
$$
...
\multicolumn{2}{|c|}{Причинность}\\
 \hline
$q_i(0), p_i(0)$ & $i\hbar \frac{\partial}{\partial{t}}\Psi (\vec{r}, t)=(-\frac{\hbar^2}{2m}\vec{\nabla}^2+V(\vec{r}))\Psi (\vec{r}, t)$\\
$$ & --уравнение Шрединегера;\index{Уравнение Шредингера}\\
$$ & причинность носит не траекторный, а стастический характер\\
\hline
